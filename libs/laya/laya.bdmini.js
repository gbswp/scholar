	...
	var MiniSound$1 = (function (_super) {
		...
		__proto.play = function (startTime, loops) {
			...
			if (this.url == SoundManager._tMusic) {
				...
				tSound = MiniSound._musicAudio = MiniSound._createSound();
			} else {
				// if (MiniSound._audioCache[this.readyUrl]) {
			...
			tSound.onCanplay(MiniSound.bindToThis(this.onCanPlay, this));
			tSound.onError(MiniSound.bindToThis(this.onError, this));
			this._sound = tSound;
