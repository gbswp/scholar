    ...
    ProtoBuf.Reflect = (function (ProtoBuf) {
        ...
        MessagePrototype.build = function (rebuild) {
            ...
            var clazz = (function (ProtoBuf, T) {
                 ...
                 */
                Message.decode = function (buffer, length, enc, obj) {
                    ...
                    var le = buffer.littleEndian;
                    try {
                        var msg = T.decode(buffer.LE(), undefined, undefined, obj);
                        buffer.LE(le);
                        return msg;
                    } catch (e) {
                        buffer.LE(le);
         ...
         * @expose
         */
        MessagePrototype.decode = function (buffer, length, expectedGroupEndId, obj) {
            length = typeof length === 'number' ? length : -1;
            var start = buffer.offset,
                msg = obj ? obj : new (this.clazz)(),
    ...
    ProtoBuf.Builder = (function (ProtoBuf, Lang, Reflect) {
        ...
        BuilderPrototype.resolveAll = function () {
            ...
            if (this.ptr instanceof Reflect.Namespace) { // Resolve children
                ...
                // default
                if (this.ptr.repeated && this.ptr.options.packed === undefined &&
