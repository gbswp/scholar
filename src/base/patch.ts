...
(function () {
    ...
    Object.defineProperty(_proto, "badge", {
        get: function (): boolean {
            return !!this._badgeVisible;
        },
        set: function (value: boolean) {
            if (this._badgeVisible == value) return;
    ...
    Object.defineProperty(_proto, "badgeStyle", {
        get: function (): IBadgeStyle {
            return this._badgeStyle;
        },
        set: function (style: IBadgeStyle) {
    ...
    Object.defineProperty(_proto, "badgeEnable", {
        get: function (): boolean {
            return this._badgeEnable;
        },
        set: function (value: boolean) {
            if (this._badgeEnable == value) return;
            this._badgeEnable = value;
            this.updateBadge();
        },
        enumerable: false,
        configurable: false
    ...
    _proto.updateBadge = function (): void {
        if (this.destroyed) return;
        let badge = this['_badge'];
        let badgeVisible = this._badgeVisible && this._badgeEnable && this.visible;
        if (badgeVisible) {
            !badge && (badge = this['_badge'] = new ImageView('common/img_common_red.png'));
            badge.layoutEnabled = false;

            let style = this._badgeStyle;
            let displayIndex = style && style.displayIndex >= 0 ? style.displayIndex : 1;
            let pos = new Laya.Point(this.width - (badge.width || 28), 0)
            let container = this;
            while (displayIndex > 0) {
                if (!container.parent) break;
                pos = container.toParentPoint(pos);
                container = container.parent;
                displayIndex--;
            }
            container && container.addChild(badge);
            badge.x = pos.x;
            badge.y = pos.y;
            if (style) {
                badge.x += style.diffX || 0;
                badge.y += style.diffY || 0;
                badge.anchorX += style.anchorOffsetX || 0;
                badge.anchorY += style.anchorOffsetY || 0;
            }
        }
        badge && (badge.visible = badgeVisible);
    }

    Object.defineProperty(_proto, "openKey", {
        get: function (): string {
            return this._openKey;
        },
        set: function (value: string) {
            value = _.trim(value, "$");
            if (this._openKey == value) return;
            this._openKey = value;
        },
        enumerable: false,
        configurable: false
    ...
    Object.defineProperty(_proto, "visible", {
        get: function (): boolean {
            return this["_$get_visible"]();
        },
        set: function (value: boolean) {
            this["_$set_visible"](value);
            this.updateBadge();
        },
        enumerable: false,
        configurable: false
